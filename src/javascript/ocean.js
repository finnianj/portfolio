...
const messages = [
  ...
  "It feels good to clean the ocean floor. But where does all that junk come from?",
  ...
  "Since I deleted Instagram, I get all my dopamine from LinkedIn!",
  "*boom* *ga* *dadum* *ga* go the drums!",
  "Rhythm is a trance, and life is a dance!",
]
